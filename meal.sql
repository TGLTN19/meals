...
CREATE TABLE `food`  (
  ...
  `feature` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '暂无',
  `material` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '暂无',
  `price` int(11) NOT NULL,
  `type` int(1) NOT NULL,
  `picture` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `food` VALUES (33, '瘦身苹果牛奶饮', '特色：苹果有安眠养神、补中益气、消食化积之特长。瘦身苹果牛奶饮让你首先感觉到的是苹果的甜香，然后是牛奶的浓郁、香滑。临睡前喝一碗，不但可以帮助睡眠，也不会长胖。', '主料：苹果250g,牛奶200g。', 11, 4, 'images/yinpin/03.jpg', 4, -1);
